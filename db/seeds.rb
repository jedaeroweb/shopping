...
Admin.create!(:id => 1, :email => 'admin@jedearoweb.co.kr', :name => '잠자는사자', :password => 'a12345', :password_confirmation => 'a12345', admin_picture_attributes: { picture: File.open(Rails.root.join("app", "assets", "images", "dog.png")) })
